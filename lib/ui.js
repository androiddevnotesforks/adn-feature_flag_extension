...
;// CONCATENATED MODULE: ./src/ui/components/Container.tsx
...
;// CONCATENATED MODULE: ./src/ui/components/flags/BooleanFlag.tsx
...
const icons = {
    ...
    uncheked_changed: chrome.runtime.getURL("assets/icons/unchecked_changed.svg"),
};
const BooleanFlag = ({ value, isChanged, onChange }) => {
    ...
    return (react.createElement(BooleanFlag_Container, null,
        react.createElement(Icon, { src: src }),
        react.createElement(Checkbox, { type: "checkbox", checked: value, onClick: () => onChange(!value), isChanged: isChanged })));
};
const BooleanFlag_Container = styled_components_browser_esm.div `
    /* padding: 10px; */
    border-radius: 3px;
    position: relative;
    display: flex;
...
`;
const Checkbox = styled_components_browser_esm.input `
    position: absolute;
    left: 0;
    top: 0;
    width: 100%;
...
;// CONCATENATED MODULE: ./src/ui/components/flags/NumberFlag.tsx


const NumberFlag = ({ value, isChanged, onChange }) => {
    const [isError, setIsError] = (0,react.useState)(false);
    const initialValue = (0,react.useMemo)(() => value, []);
    const onInput = (0,react.useCallback)((ev) => {
    ...
    return (react.createElement(NumberFlagInput, { contentEditable: "true", isError: isError, isChanged: isChanged, onInput: onInput }, initialValue));
};
const NumberFlagInput = styled_components_browser_esm.div `
...
;// CONCATENATED MODULE: ./src/ui/components/flags/OtherFlag.tsx


const OtherFlag = ({ value, isChanged, onChange }) => {
    const [isError, setIsError] = (0,react.useState)(false);
    const initialValue = (0,react.useMemo)(() => value, []);
    const onInput = (0,react.useCallback)((ev) => {
        const newValue = ev.currentTarget.textContent || '';
    ...
    return (react.createElement(OtherFlagInput, { contentEditable: "true", isError: isError, isChanged: isChanged, onInput: onInput }, JSON.stringify(initialValue)));
};
const OtherFlagInput = styled_components_browser_esm.div `
    background-color: #F0F3F4;
    border-width: 0;
    border-radius: 5px;
    padding: 5px 10px;
...
;// CONCATENATED MODULE: ./src/ui/components/flags/StringFlag.tsx


const StringFlag = ({ value, isChanged, onChange }) => {
    const initialValue = (0,react.useMemo)(() => value, []);
    const onInput = (0,react.useCallback)((ev) => {
        const newValue = ev.currentTarget.textContent || '';
        onChange(newValue);
    }, []);
    return (react.createElement(StringFlagInput, { contentEditable: "true", isChanged: isChanged, onInput: onInput }, initialValue));
};
const StringFlagInput = styled_components_browser_esm.div `
    background-color: #F0F3F4;
    border-width: 0;
    border-radius: 5px;
    padding: 5px 10px;
...
;// CONCATENATED MODULE: ./src/ui/components/flags/Flag.tsx
...
const Flag = ({ name, value, isChanged, onChange }) => {
    let valueEl = null;
    switch (typeof value) {
        case 'boolean':
            valueEl = react.createElement(BooleanFlag, { value: value, isChanged: isChanged, onChange: onChange });
            break;
        case 'number':
            valueEl = react.createElement(NumberFlag, { value: value, isChanged: isChanged, onChange: onChange });
            break;
        case 'string':
            valueEl = react.createElement(StringFlag, { value: value, isChanged: isChanged, onChange: onChange });
            break;
        case 'object':
        default:
            valueEl = react.createElement(OtherFlag, { value: value, isChanged: isChanged, onChange: onChange });
            break;
    }
    return (react.createElement(Flag_Container, null,
        react.createElement(Label, { isChanged: isChanged }, name),
        valueEl));
};
const Flag_Container = styled_components_browser_esm.div `
    ...
    max-width: 100%;
`;
const Label = styled_components_browser_esm.div `
    font-size: 14px;
...
;// CONCATENATED MODULE: ./src/ui/components/FlagsList.tsx



const FlagsList = ({ featureFlags, changes, onValueChange }) => {
    const featureFlagNames = Object.keys(featureFlags);
    return (react.createElement(FlagsList_Container, null, featureFlagNames.map((ffk) => react.createElement(Flag, { key: ffk, name: ffk, isChanged: !!changes[ffk], value: changes[ffk]?.value ?? featureFlags[ffk]?.value, onChange: (newValue) => onValueChange(ffk, newValue) }))));
};
const FlagsList_Container = styled_components_browser_esm.div `
    flex-grow: 1;
    overflow-y: auto;
    padding: 10px 0;
`;

;// CONCATENATED MODULE: ./src/ui/components/Button.tsx

const Button = styled_components_browser_esm.button `
    font-weight: bold;
    color: white;
    height: 40px;
    font-size: 16px;
...
`;
const ButtonLink = styled_components_browser_esm.button `
    font-weight: 500;
    color: #91A0B0;
    height: 30px;
    font-size: 14px;
...
;// CONCATENATED MODULE: ./src/ui/components/Footer.tsx



const Footer = ({ isCanSave, onSave, onClear }) => {
    return (react.createElement(Footer_Container, null,
        react.createElement(Block, null),
        react.createElement(Block, null,
            react.createElement(Button, { disabled: !isCanSave, onClick: onSave }, "Save Changes")),
        react.createElement(Block, { style: { justifyContent: 'flex-end' } },
            react.createElement(ButtonLink, { onClick: onClear }, "Clear State"))));
};
const Footer_Container = styled_components_browser_esm.div `
    display: flex;
    flex-direction: row;
    ...
    padding: 15px;
`;
const Block = styled_components_browser_esm.div `
    flex: 1;
    display: flex;
    justify-content: center;
    align-items: center;
...
;// CONCATENATED MODULE: ./src/ui/components/Header.tsx

const Header = styled_components_browser_esm.div `
    width: 100%;
    box-sizing: border-box;
    border-bottom: 1px solid rgba(0,0,0,0.05);
`;

;// CONCATENATED MODULE: ./src/ui/components/Search.tsx
...
const Search = ({ initialValue = '', onChange }) => {
    ...
    return (react.createElement(Search_Container, null,
        react.createElement(SearchInput, { placeholder: "Search Features", value: inputValue, onChange: handleChange })));
};
const Search_Container = styled_components_browser_esm.div `
    padding: 15px 15px 0 15px;
    width: 100%;
    box-sizing: border-box;
`;
const SearchInput = styled_components_browser_esm.input `
    background-color: #F0F3F4;
    text-align: center;
    border-radius: 100px;
    width: 100%;
...
;// CONCATENATED MODULE: ./src/ui/components/Tabs.tsx


const Tabs = ({ selectedTab, onChange, allCount, changedCount, subscriptionsCount, }) => {
    return (react.createElement(Tabs_Container, null,
        react.createElement(Tab, { onClick: () => onChange("all") },
            react.createElement(TabLabel, { selected: selectedTab === "all" },
                "Feature Flags ",
                react.createElement(CountLabel, null,
                    "\u00A0",
                    allCount))),
        react.createElement(Tab, { onClick: () => onChange("changed") },
            react.createElement(TabLabel, { selected: selectedTab === "changed" },
                "Changed LMAOOO ",
                react.createElement(CountLabel, null,
                    "\u00A0",
                    changedCount))),
        react.createElement(Tab, { onClick: () => onChange("subscriptions") },
            react.createElement(TabLabel, { selected: selectedTab === "subscriptions" },
                "Subscriptions",
                " ",
                react.createElement(CountLabel, null,
                    "\u00A0",
...
const Tabs_Container = styled_components_browser_esm.div `
    padding-top: 5px;
    height: 40px;
    width: 100%;
    display: flex;
    flex-direction: row;
`;
const Tab = styled_components_browser_esm.div `
    flex: 1;
    height: 100%;
    cursor: pointer;
    display: flex;
...
`;
const TabLabel = styled_components_browser_esm.div `
    font-size: 14px;
    font-weight: 500;
    height: 100%;
    padding: 0 10px;
    ...
    `}
`;
const CountLabel = styled_components_browser_esm.span `
    color: rgba(0, 0, 0, 0.3);
    margin-left: 5px;
`;

;// CONCATENATED MODULE: ./src/ui/hooks/useFlags.ts

const useFlags = ({ search }) => {
    const [featureFlags, setFeatureFlags] = (0,react.useState)({});
    const [featureFlagsFromRemote, setFeatureFlagsFromRemote] = (0,react.useState)({});
    const [changes, setChanges] = (0,react.useState)({});
    const flags = (0,react.useMemo)(() => ({ ...featureFlagsFromRemote, ...featureFlags }), [featureFlags, featureFlagsFromRemote]);
    (0,react.useEffect)(() => {
    ...
    const shownFeatureFlags = (0,react.useMemo)(() => Object.keys(flags).reduce((acc, ffname) => {
    ...
    const shownChanges = (0,react.useMemo)(() => Object.keys(changes).reduce((acc, ffname) => {
        const isSatisfySearch = !search || ffname.indexOf(search) > -1;
        if (isSatisfySearch) {
            return { ...acc, [ffname]: flags[ffname] };
        }
    ...
    const onValueChange = (0,react.useCallback)(async (name, newValue) => {
        let newFeatureFlagChanges = {};
...
;// CONCATENATED MODULE: ./src/ui/hooks/useSubscriptions.ts

const useSubscriptions = ({ search }) => {
    const [subscriptions, setSubscriptions] = (0,react.useState)({});
    const [subscriptionsFromRemote, setSubscriptionsFromRemote] = (0,react.useState)({});
    ...
    (0,react.useEffect)(() => {
        ...
        const listener = (changes) => {
            ...
            if (changes["subscriptionsFromRemote"]) {
                setSubscriptionsFromRemote(changes["subscriptionsFromRemote"].newValue || {});
            }
    ...
    const shownSubscriptions = (0,react.useMemo)(() => Object.keys(allSubscriptions).reduce((acc, sname) => {
    ...
    const onValueChange = (0,react.useCallback)((name, newValue) => {
        let newSubscriptionsChanges = {};
...
;// CONCATENATED MODULE: ./src/ui/components/UsageWarning.tsx



const UsageWarning = ({ onConfirm }) => {
    return (react.createElement(UsageWarning_Container, null,
        react.createElement(Title, null, "\u2622\uFE0F Use this extension at your own risk \u2622\uFE0F"),
        "Changing feature flags can activate work-in-progress features, however they are usually incomplete, can include bugs and might change before release.",
        react.createElement("br", null),
        react.createElement("br", null),
        "In rare cases changing flags can also introduce permanent bugs to your account.",
        react.createElement("br", null),
        react.createElement("br", null),
        react.createElement("br", null),
        react.createElement(Button, { onClick: onConfirm, disabled: false }, "I understand")));
};
const UsageWarning_Container = styled_components_browser_esm.div `
    padding: 20px;
    box-sizing: border-box;
    margin: 0 20px;
    display: flex;
    ...
    border-radius: 10px;
`;
const Title = styled_components_browser_esm.div `
    font-size: 18px;
    font-weight: 600;
    margin-bottom: 20px;
    text-align: center;
...
;// CONCATENATED MODULE: ./src/ui/hooks/useStorageState.ts
...
;// CONCATENATED MODULE: ./src/ui/FeatureFlagsScreen.tsx
...
const FeatureFlagsScreen = () => {
    ...
    const [isWarningConfirmed, isLoading, setWarningConfirmed] = useStorageState("isWarningConfirmed", false);
    const { shownFlags, shownChanges, changes: flagsChanges, changeFlag, } = useFlags({
        search,
    });
    const { shownSubscriptions, changes: subscriptionsChanges, changeSubscription, } = useSubscriptions({ search });
    const onSave = () => {
    ...
    if (!isWarningConfirmed) {
        return react.createElement(UsageWarning, { onConfirm: () => setWarningConfirmed(true) });
    }
    switch (selectedTab) {
        case "all":
            content = (react.createElement(FlagsList, { featureFlags: shownFlags, changes: flagsChanges, onValueChange: changeFlag }));
            break;
        case "changed":
            content = (react.createElement(FlagsList, { featureFlags: shownChanges, changes: flagsChanges, onValueChange: changeFlag }));
            break;
        case "subscriptions":
            content = (react.createElement(FlagsList, { featureFlags: shownSubscriptions, changes: subscriptionsChanges, onValueChange: changeSubscription }));
            break;
    }
    return (react.createElement(Container, null,
        react.createElement(Header, { style: { borderBottom: "1px solid rgba(0,0,0,0.05);" } },
            react.createElement(Search, { initialValue: search, onChange: setSearch }),
            react.createElement(Tabs, { allCount: Object.keys(shownFlags).length, changedCount: Object.keys(shownChanges).length, subscriptionsCount: Object.keys(shownSubscriptions).length, selectedTab: selectedTab, onChange: setSelectedTab })),
        content,
        react.createElement(Footer, { onClear: onClear, isCanSave: true, onSave: onSave })));
};
const onClear = async () => {
...
;// CONCATENATED MODULE: ./src/ui/ui.tsx



const root = (0,client/* createRoot */.s)(document.getElementById('root'));
root.render(react.createElement(FeatureFlagsScreen, null));
